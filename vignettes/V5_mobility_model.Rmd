...
The prediction error results compare actual trip count values in the data matrix $M$ with the predicted values of the estimated mobility model ($\hat{M}$). These results indicate that our model has an average magnitude of error of about 474 trip counts (RMSE), which is on average about 1% of oberved trip count values. The R-squared is high, showing that our model captures approximately 86% of the variance observed in the supplied mobility data.
